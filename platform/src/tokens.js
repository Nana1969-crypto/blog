...
const primitives = {
  ...
  brand700: '#0a7d55', brand800: '#086a48', brand300: '#34d399', brand200: '#6ee7b7',
...
const themes = {
  light: {
    ...
    'color-accent': primitives.brand700,
    'color-accent-hover': primitives.brand800,
    'color-focus': primitives.brand700,
  ...
  dark: {
    ...
    'color-accent': primitives.brand300,
    'color-accent-hover': primitives.brand200,
    'color-focus': primitives.brand300,
